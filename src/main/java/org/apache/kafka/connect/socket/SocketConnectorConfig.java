...
public class SocketConnectorConfig extends AbstractConfig {
  ...
  public static ConfigDef baseConfigDef() {
    return new ConfigDef()
        .define(CONNECTION_URL_CONFIG, Type.STRING, Importance.HIGH, CONNECTION_URL_DOC, TCPSERVER_GROUP, 1, Width.LONG,
                CONNECTION_URL_DISPLAY)
        .define(TYPE_NAME_CONFIG, Type.STRING, Importance.HIGH, TYPE_NAME_DOC, TCPSERVER_GROUP, 2, Width.SHORT, TYPE_NAME_DISPLAY)
